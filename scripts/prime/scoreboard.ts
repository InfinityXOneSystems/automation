...
class ScoreboardGenerator {
   ...
   * Generate scoreboard
   */
  async generate(): Promise<Scoreboard> {
   ...
   */
  private getExampleMetrics(): RepoMetrics[] {
    return [
      {
        repo: 'automation',
        reliability: 95,
   ...
   * Save scoreboard
   */
  private async saveScoreboard(scoreboard: Scoreboard): Promise<void> {
    // Save JSON
   ...
   */
  private generateMarkdown(scoreboard: Scoreboard): string {
